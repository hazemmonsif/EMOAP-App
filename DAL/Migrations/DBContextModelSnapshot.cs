...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Model.PersonWithoutAccount", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("DescriptionForPatient")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double>("MainLatitude")
                        .HasColumnType("float");

                    b.Property<double>("MainLongitude")
                        .HasColumnType("float");
                    ...
                    b.ToTable("PersonWithoutAccounts");
                });
            ...
            modelBuilder.Entity("DAL.Model.Family", b =>
                {
                    ...
                    b.Property<int>("NumberOfTrainingImage")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Model.PersonWithoutAccount", b =>
                {
                    b.HasOne("DAL.Model.Patient", "Patient")
                        .WithMany("personsWithoutAccount")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Model.SecretAndImportantFile", b =>
                {
                    b.HasOne("DAL.Model.Patient", "patient")
                        .WithMany("SecretAndImportantFiles")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Model.Patient", b =>
                {
                    ...
                    b.Navigation("SecretAndImportantFiles");

                    b.Navigation("families");

                    b.Navigation("personsWithoutAccount");
                });
